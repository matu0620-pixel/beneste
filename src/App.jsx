...
.bs-mascot-bubble {
  ...
  max-width: 180px;
  z-index: 6;
  box-shadow: 0 4px 12px rgba(0, 63, 142, 0.1);
...
.bs-bubble-taro { color: #003F8E; }
.bs-bubble-kichi { color: #1A5CB0; animation-delay: 0.2s; }
.bs-bubble-maru { color: #C73E2E; animation-delay: 0.4s; }
